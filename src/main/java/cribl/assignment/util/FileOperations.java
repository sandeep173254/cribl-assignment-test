...
public class FileOperations {
	...
	{
		PrintWriter pw = new PrintWriter("output_events.log");
	...
	public boolean checkFileDataMatches()
	{
		boolean verifyFileDataMatches=true;
		ClassLoader classLoader = getClass().getClassLoader();
		File input_file = new File(classLoader.getResource("input_file.log").getFile());
		File output_file = new File(classLoader.getResource("output_events.log").getFile());
